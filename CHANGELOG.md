# История изменений
 ...
 - Добавлены режимы работы танго-сервера. Реализован режим по умолчанию SERVER
 - Мьютекс, при отправлении сообщений, а также при закрытии и открытии соединения, не используется в клиентских режимах
 - Реализованы режимы работы танго модуля SERVNCLIENT_ALL_RO и CLIENT_ALL_RO. Используются для управление видом обновляемой информацией клиентом. 
