# История изменений
 - Убран std::setprecision(5) по умолчанию. Сейчас std::setprecision(0)
 - Добавлена возможность установления периодичности вывода значений для атрибутов
 - В возвращаемый json, добавлены data_type и data_format с типом  и форматом данных для атрибутов, и
data_type с типом данных для команд.
