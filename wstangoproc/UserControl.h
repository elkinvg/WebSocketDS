...
namespace WebSocketDS_ns
{
    ...
    public:
        ...
        bool check_permission(const ParsedInputJson& parsedInputJson, const unordered_map<string, string> &remoteConf, string deviceName, bool isGroup, string &mess);
        pair<bool, string> getInformationFromCheckingUser(const ConnectionData& connectionData);
        bool sendLogCommand(const WebSocketDS_ns::ParsedInputJson &parsedInputJson, const std::unordered_map<std::string, std::string> &remoteConf, string deviceName, bool isGroup, bool status);
    private:
        ...
        vector<string> getPermissionData(const ParsedInputJson &parsedInputJson, const std::unordered_map<std::string, std::string> &remoteConf, const string &deviceName);
