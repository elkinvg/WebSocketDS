...
namespace WebSocketDS_ns
{
    ...
    string WSTangoConn::sendRequest(const ParsedInputJson& inputReq, bool& isBinary)
    {
        isBinary = false;
        ...
        if (typeWsReq == TYPE_WS_REQ::COMMAND) {
            ...
            string mess;
            bool permission = uc->check_permission(inputReq,_wsds->deviceServer,_isGroup, mess);
            ...
            bool isSent = uc->sendLogCommand(inputReq,_wsds->deviceServer,_isGroup,statusComm);
            if (isSent)
