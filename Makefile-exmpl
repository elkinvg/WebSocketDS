...
LIB_DIR_USER= -L/usr/lib64 -lboost_system -lssl -lcrypto
...
#
# for using -DUSELOG
# make OUT_DEF=-DUSELOG
CXXFLAGS_USR+= -Wall -D_WEBSOCKETPP_CPP11_STL_ $(OUT_DEF)
