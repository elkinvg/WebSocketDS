...
Здесь `"event_id"` - id подписки на событие. Его можно использовать при дальнейшей [отписки от события.](#Частичная-отписка-от-событий) 
...
Здесь `"event_id"`, id подписки на события, которая была произведена [ранее](#Подписка-на-события) 
