...
Выставление точности для возвращаемых значений команд проходит аналогично.  Для выставления других значений точности, к имени комманды в свойстве следует добавить `;prec=N` либо другое, из перечисленного выше.
