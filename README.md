...
Танго модуль запускается в одном из перечисленных режимов:
  ...
  - **SERVNCLIENT_ALIAS** - Серверное и клиентное управление выводом информации, считываемых с атрибутов и pipe. Запуск команд в tango-модуле (или группе), прописанном в Property. Чтение атрибутов, а также запуск команд только с танго-модулей, имеющих alias; option: `mode=ser_cli_ali`
